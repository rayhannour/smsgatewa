...
public class StatisPrisonRestAPI {


    @GrpcClient("statisprison")
    private StatisprisonServiceGrpc.StatisprisonServiceBlockingStub bankServiceBlockingStub;
    @Autowired
    ...
    private String sendDataSmgs(String from, String to, String text) throws IOException {
        ...
        param.append("?username=cgprws");
        param.append("&password=cgprws");
