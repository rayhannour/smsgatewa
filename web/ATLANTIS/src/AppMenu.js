        ...
        <div className={classNames('layout-menu-wrapper', { 'layout-sidebar-active': props.sidebarActive })}
            ...
            <div className="menu-logo">
                <button className="logo p-link">
                    <img src={`assets/layout/images/logo-${props.colorScheme === 'light' ? 'dark' : 'light'}.png`} alt="logo" onClick={() => history.push('/')} style={{height:"60px",marginLeft: "-10px"}}/>
                </button>
            ...
            <AppInlineMenu keycloaks={props.keycloaks} menuMode={props.menuMode} activeInlineProfile={props.activeInlineProfile} onChangeActiveInlineMenu={props.onChangeActiveInlineMenu} />
        </div>
    )
}
