        ...
        <div className="p-grid">
            <div className="p-col-12">
                <div className="card docs no-margin">
                    ...
                    <p>Atlantis is an application template for React, based on the popular <a href="https://github.com/facebook/create-react-app">create-react-app</a> that allows
...
`}
                    ...
                    <h4>Structure</h4>
                    <p>Atlantis consists of 3 main parts; the application layout, layout resources and theme resources for PrimeReact components. <b>App.js</b> inside src folder is the main component containing the template for the base layout
...
const menu = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Landing', icon: 'pi pi-globe', url: 'assets/landing.html', target: '_blank' },
...
`}
                    ...
                    <p>Variables of the light component theme, see the <a href="https://www.primefaces.org/designer/api/primereact/6.3.0/">Theme Designer API</a> for documentation.</p>
...
<h4>Menu Modes</h4>
                <p>Menu has 5 modes; static, overlay, slim, horizontal and sidebar. Layout wrapper element in App.js is 
