            ...
            <div className="p-col-12 p-lg-8">
                <div className="card">
                    ...
                    <div className="p-field p-grid p-align-start">
                        <label htmlFor="username1" className="p-col-fixed p-sr-only">Username</label>
                        <div className="p-col">
                            <InputText id="username1" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} required className="p-invalid"></InputText>
                            <Message severity="error" text="Username is required" />
                        </div>
                    </div>
                    <div className="p-field p-grid">
                        <label htmlFor="email" className="p-col-fixed p-sr-only">Email</label>
                        <div className="p-col">
                            <InputText id="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} required className="p-invalid"></InputText>
